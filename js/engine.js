import { calculateAlphaMap } from 'https://cdn.jsdelivr.net/gh/xpromptss/nxprompts@refs/heads/main/js/alphaMap.js';
import { removeWatermark } from 'https://github.com/xpromptss/nxprompts/raw/refs/heads/main/js/blendModes.js';
    ...
    static async create() {
        ...
        try {
            const [bg48, bg96] = await Promise.all([
                loadImage('https://cdn.jsdelivr.net/gh/xpromptss/nxprompts@refs/heads/main/assets/bg_48.png'),
                loadImage('https://cdn.jsdelivr.net/gh/xpromptss/nxprompts@refs/heads/main/assets/bg_96.png')
            ]);
